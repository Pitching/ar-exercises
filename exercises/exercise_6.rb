...
# it has a `store_id` (integer) column. This is a column that identifies which store each employee belongs to. 
...
@store1.employees.create(first_name: "Billy", last_name: "Burnham", hourly_rate: 50)
@store1.employees.create(first_name: "Ronald", last_name: "Weasley", hourly_rate: 70)

@store2.employees.create(first_name: "Donald", last_name: "Duck", hourly_rate: 80)
@store2.employees.create(first_name: "Omni", last_name: "Man", hourly_rate: 300)
